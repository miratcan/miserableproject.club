...
from .views import SubmissionDetailView, SubmitView, LatestFeed, DeleteSubmissionView, SubmissionImportView
...
urlpatterns = [
    ...
    path('import/', SubmissionImportView.as_view(), name='submission_import'),
